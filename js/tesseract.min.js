...
!(function (t, r) {
   ...
   (() => {
      var t = {
                  ...
                  return (
                     ...
                     (N.prototype = {
                        ...
                        delegateYield: function (t, e, n) {
                           return (this.delegate = { iterator: A(t), resultName: e, nextLoc: n }), "next" === this.method && (this.arg = r), g;
                        },
                     }),
                     t
                  );
                  ...
                  return (
                     ...
                     (P.prototype = {
                        ...
                        delegateYield: function (t, r, e) {
                           return (this.delegate = { iterator: k(t), resultName: r, nextLoc: e }), "next" === this.method && (this.arg = void 0), p;
                        },
                     }),
                     t
                  );
            ...
            711: (t) => {
               t.exports = { OSD_ONLY: "0", AUTO_OSD: "1", AUTO_ONLY: "2", AUTO: "3", SINGLE_COLUMN: "4", SINGLE_BLOCK_VERT_TEXT: "5", SINGLE_BLOCK: "6", SINGLE_LINE: "7", SINGLE_WORD: "8", CIRCLE_WORD: "9", SINGLE_CHAR: "10", SPARSE_TEXT: "11", SPARSE_TEXT_OSD: "12", RAW_LINE: "13" };
            },
            341: (t) => {
                           ...
                           switch ((t.prev = t.next)) {
                              case 0:
                                 return (
                                    ...
                                    (A = e),
                                    (G = c),
                                    (I = [m.DEFAULT, m.LSTM_ONLY].includes(e) && !k.legacyCore),
                                    ...
                                    (H = function (t) {
                                       return B(v({ id: t, action: "load", payload: { options: { lstmOnly: I, corePath: k.corePath, logging: k.logging } } }));
                                    }),
                                    (K = function (t, r, e) {
                                       return B(v({ id: e, action: "FS", payload: { method: "writeFile", args: [t, r] } }));
                                    }),
                                    (W = function (t, r) {
                                       return B(v({ id: r, action: "FS", payload: { method: "readFile", args: [t, { encoding: "utf8" }] } }));
                                    }),
                                    (J = function (t, r) {
                                    ...
                                    (Q = function (t, r) {
                                       return B(v({ id: r, action: "loadLanguage", payload: { langs: t, options: { langPath: k.langPath, dataPath: k.dataPath, cachePath: k.cachePath, cacheMethod: k.cacheMethod, gzip: k.gzip, lstmOnly: [m.DEFAULT, m.LSTM_ONLY].includes(A) && !k.legacyLang } } }));
                                    }),
                                    (q = function () {
                                    ...
                                    ($ = function () {
                                       ...
                                       G = i;
                                       var c,
                                          u = ("string" == typeof t ? t.split("+") : t).filter(function (t) {
                                             return !N.includes(t);
                                          });
                                       return (
                                          N.push.apply(
                                    ...
                                    (tt = function () {
                                       return B(v({ id: arguments.length > 1 ? arguments[1] : void 0, action: "setParameters", payload: { params: arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {} } }));
                                    }),
                                    (rt = (function () {
                                       var t = h(
                                          i().mark(function t(r) {
                                             ...
                                             return i().wrap(function (t) {
                                                for (;;)
                                                   switch ((t.prev = t.next)) {
                                                      case 0:
                                                         return (e = a.length > 1 && void 0 !== a[1] ? a[1] : {}), (n = a.length > 2 && void 0 !== a[2] ? a[2] : { blocks: !0, text: !0, hocr: !0, tsv: !0 }), (o = a.length > 3 ? a[3] : void 0), (t.t0 = B), (t.t1 = v), (t.t2 = o), (t.next = 8), E(r);
                                                      case 8:
                                                         return (t.t3 = t.sent), (t.t4 = e), (t.t5 = n), (t.t6 = { image: t.t3, options: t.t4, output: t.t5 }), (t.t7 = { id: t.t2, action: "recognize", payload: t.t6 }), (t.t8 = (0, t.t1)(t.t7)), t.abrupt("return", (0, t.t0)(t.t8));
                                                      case 15:
                                                      case "end":
                                                         return t.stop();
                                                   }
                                    ...
                                    (et = function () {
                                       var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "Tesseract OCR Result",
                                          ...
                                          e = arguments.length > 2 ? arguments[2] : void 0;
                                       return console.log("`getPDF` function is depreciated. `recognize` option `savePDF` should be used instead."), B(v({ id: e, action: "getPDF", payload: { title: t, textonly: r } }));
                                    }),
                                    (nt = (function () {
                                       var t = h(
                                    ...
                                    O(C, function (t) {
                                       ...
                                       if ("resolve" === n) {
                                          ...
                                          var c = i;
                                          "recognize" === o ? (c = y(i)) : "getPDF" === o && (c = Array.from(u(u({}, i), {}, { length: Object.keys(i).length }))), _[a]({ jobId: e, data: c });
                                       } else if ("reject" === n) {
                                          if ((T[a](i), "load" === o && F(i), !P)) throw Error(i);
                                          P(i);
                                       } else "progress" === n && b(u(u({}, i), {}, { userJobId: e }));
                                    }),
                                    (it = { id: f, worker: C, setResolve: U, setReject: Y, load: z, writeText: K, readText: W, removeFile: J, FS: V, loadLanguage: Z, initialize: q, reinitialize: $, setParameters: tt, recognize: rt, getPDF: et, detect: nt, terminate: ot }),
                                    H()
                                       .then(function () {
                                          return Q(r);
                                       })
